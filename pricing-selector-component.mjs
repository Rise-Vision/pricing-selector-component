...
class PricingSelectorComponent extends PolymerElement {
  static get properties() {
    return {
      ...
      periodYearlyText: {type: String, value: "I want to pay yearly, by credit card or invoice, and save 50% for the first year"},
      periodMonthlyText: {type: String, value: "I want to pay monthly, by credit card, with no yearly savings"},
